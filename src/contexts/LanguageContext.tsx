...
const translations = {
  en: {
    ...
    'register.step4.is_bcs': 'Are you a BCS Cadre?',
    'register.step4.bcs_session': 'BCS Batch',
    'register.step4.bcs_session.placeholder': 'Enter BCS batch/session (e.g. 35th)',
    'register.step4.bcs_session_required': 'BCS batch/session is required',
  ...
  bn: {
    ...
    'register.step4.is_bcs': 'আপনি কি বিসিএস ক্যাডার?',
    'register.step4.bcs_session': 'বিসিএস ব্যাচ',
    'register.step4.bcs_session.placeholder': 'বিসিএস ব্যাচ/সেশন লিখুন (যেমন ৩৫তম)',
    'register.step4.bcs_session_required': 'বিসিএস ব্যাচ/সেশন আবশ্যক',
