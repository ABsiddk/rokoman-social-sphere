          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
                Join our vibrant community where connections flourish, ideas grow, and opportunities abound. 
                Experience the power of collaborative networking in a secure, private environment.
              </p>
            </div>
            ...
            <div className="flex items-center space-x-8 pt-4">
              ...
              <div className="text-center">
                ...
                <div className="text-gray-600 dark:text-gray-400">Daily Connections</div>
              </div>
              <div className="text-center">
            ...
            <div className="relative bg-gray-100 dark:bg-gray-700 rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute inset-0 bg-black bg-opacity-20 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300">
                <div className="text-white text-center">
                  <h3 className="text-xl font-semibold mb-2">Community Overview</h3>
                  <p className="text-sm">Discover what makes us special</p>
                </div>
              </div>
            </div>
          </div>
